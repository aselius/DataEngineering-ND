...
user_table_create = ("""
CREATE TABLE users (user_id serial PRIMARY KEY, first_name varchar, last_name varchar,
gender varchar, level varchar);
""")

song_table_create = ("""
CREATE TABLE songs (song_id varchar PRIMARY KEY, title varchar,
artist_id varchar REFERENCES artists, year integer, duration float);
""")

artist_table_create = ("""
CREATE TABLE artists (artist_id varchar PRIMARY KEY, name varchar, location varchar,
latitude integer, longitude integer);
""")

time_table_create = ("""
CREATE TABLE time (start_time integer, hour integer, day integer, week integer, month integer, year integer, weekday varchar);
""")

songplay_table_create = ("""
CREATE TABLE songplay (songplay_id serial PRIMARY KEY, start_time integer,
user_id serial REFERENCES users, level varchar,
song_id varchar REFERENCES songs, artist_id varchar REFERENCES artists, session_id varchar,
...
artist_table_insert = ("""
INSERT INTO artists(artist_id, name, location, latitude, longitude) VALUES(%s, %s, %s,
%s, %s) ON CONFLICT (artist_id) DO NOTHING;
""")
